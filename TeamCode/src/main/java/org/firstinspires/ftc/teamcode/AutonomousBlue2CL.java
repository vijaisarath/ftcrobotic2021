...
@Autonomous(name = "Autonomous Blue Carousel", group = "Linear Opmode")
// @Disabled
public class AutonomousBlue2CL extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //2nd try
        moveFront(0.45, 0.10f);
        carouselMotorLeftON();
        sleep(600);
        carouselMotorOFF();

        //3rd try
        moveFront(0.35, 0.15f);
        carouselMotorLeftON();
        sleep(600);
        carouselMotorOFF();

        moveFront(0.65, 0.10f);
        carouselMotorLeftON();
        sleep(600);
        carouselMotorOFF();
        ...
        // Check if near to wall move back to X position and arm down
        while (myRobot.distanceSensor.getDistance(DistanceUnit.CM) < 90
                && opModeIsActive() && runtime.seconds() < 25) {
            moveBack(0.9, 1.1f);
        }
